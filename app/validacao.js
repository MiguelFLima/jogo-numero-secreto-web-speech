function verificaSeOChutePossuiUmValorValido() {
    ...
    if (numeroForMaiorOuMenorQueOValorPermitido(numero)) {
        elementoChute.innerHTML += `<div>Valor Inválido: O número precisa estar no range de ${menorValor} e ${maiorValor}</div>` 
        return
    }
    ...
    if (numero === numeroSecreto) {
        document.body.innerHTML = `
            <h2>Você acertou!</h2>
            <h3>O número secreto era <strong>${numero}</strong></h3>
